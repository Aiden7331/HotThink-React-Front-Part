  ...
  render() {
    return (
      <div style={{margin: "10%", fontSize:"14px"}}>
        <div style={{textAlign:"center"}}> <h1>이용약관</h1><br/><br/> </div>
        <div>
          <p style={{textAlign:"center"}}><h4>제 1 장 총칙</h4></p>
          <br/>
          <p style={{fontWeight:"bold", fontSize:"20px"}}>제 1 조 (목적)</p>
          본 약관은 핫띵크가 운영하는 웹 사이트 (http://localhost3000)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.<br/>
          <br/>
          <p style={{fontWeight: "bold", fontSize:"20px"}}>제 2 조 (용어의 정의)</p>
          ...
          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제 3 조 (약관의 공시 및 효력과 변경)</p>
          ...
          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제 4 조 (약관 외 준칙)</p>
        ...
        <div>
          <br/>
          <p style={{textAlign:"center"}}> <h4>제 2 장 이용 계약</h4></p>

          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}> 제 5 조 (이용신청)</p>
          ...
          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제 6 조 (이용신청의 승낙)</p>
        ...
        <div>
          <p style={{textAlign:"center"}}> <h4>제 3 장 계약 당사자의 의무</h4></p>

          <br/>
          <p style={{fontWeight:"bold", fontSize:"20px"}}>제 7 조 (회사의 의무)</p>
          ...
          <br/>
          <p style={{fontWeight:"bold", fontSize:"20px"}}>제 8 조 (이용자의 의무)</p>
        ...
        <div>
          <br/>
          <p style={{textAlign:"center"}}><h4>제 4 장 서비스의 제공 및 이용</h4> </p>

          <br/>
          <p style={{fontWeight:"bold", fontSize:"20px"}}>제 9 조 (서비스 이용)</p>
          ①이용자는 본 약관의 규정된 사항을 준수해 사이트를 이용한다.<br/>
          ②본 약관에 명시되지 않은 서비스 이용에 관한 사항은 회사가 정해 '공지사항'에 게시하거나 또는 별도로 공지하는 내용에 따른다.<br/>

          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제 10 조 (정보의 제공)</p>
          회사는 회원이 서비스 이용 중 필요하다고 인정되는 다양한 정보에 대하여 전자메일이나 서신우편 등의 방법으로 회원에게 정보를 제공할 수 있다.<br/>

          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제 11 조 (광고게재)</p>
          ...
          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제 12 조 (서비스 이용의 제한)</p>
          ...
          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제 13 조 (서비스 제공의 중지)</p>
          ...
          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제 14 조 (게시물 관리)</p>
          회사는 건전한 통신문화 정착과 효율적인 사이트 운영을 위하여 이용자가 게시하거나 제공하는 자료가 제12조에 해당한다고 판단되는 경우에 임의로 삭제, 자료이동, 등록거부를 할 수 있다.<br/>

          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제 15 조 (서비스 이용 책임)</p>
        ...
        <div>
          <br/><p style={{textAlign:"center"}}><h4> 제 5 장 (재화의 주문 및 결제 관련)</h4></p>

          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제16조 (결제방법)</p>
          ‘회원’은 ‘회사’에서 판매하는 재화에 대하여 ‘선불카드, 직불카드, 신용카드 등의 각종 카드 결제 수단’을 이용하여 결제할 수 있다. 이때 ‘회사’는 이용자의 지급방법에 대하여 재화외 어떠한 명목의 수수료를 추가 징수하지 않는다.<br/><br/>
          ...
          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제17조 (배송정책)</p>
          ...
          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>18조 (취소 및 반품 환불 규정)</p><br/>
        ...
        <div>
          <br/>
          <p style={{textAlign:"center"}}><h4>제 6 장 기타</h4></p>

          <br/>
          <p style={{fontWeight:"bold", fontSize:"20px"}}>제 19 조 (면책 및 손해배상)</p>
          ...
          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제 20 조 (개인신용정보 제공 및 활용에 대한 동의서)</p>
          ...
          <br/><p style={{fontWeight:"bold", fontSize:"20px"}}>제 21 조 (분쟁의 해결)</p>
